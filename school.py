...
#    Oct 11, 2018 08:09:08 PM EDT  platform: Windows NT
...
class New_Toplevel:
    def __init__(self, top=None):
        ...
        self.Combobox1 = ttk.Combobox(top,textvariable=school_support.list3,values=['Cluster1','Cluster2','Cluster3','Cluster4','Cluster5'])
